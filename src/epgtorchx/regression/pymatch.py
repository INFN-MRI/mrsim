...
__all__ = ['map2tsmi', 'tsmi2map']


def map2tsmi(bloch_dict: BlochDictionary, qmaps: np.ndarray, m0: np.ndarray = None):
    """
...
def tsmi2map(bloch_dict: BlochDictionary, time_series: np.ndarray):
    """
